...
public abstract class CompilerError extends Exception
{
   ...
   public enum Type {ILLEGAL_CHARACTER, BAD_COMMENT, UNTERMINATED_COMMENT, UNMATCHED_COMMENT, IDENTIFIER_TOO_LONG, 
	   ...
	   PARAMETER_MISMATCH, ARRAY_WITHOUT_SUBSCRIPTS, VARIABLE_WITH_SUBSCRIPTS, UNDECLARED_VARIABLE, 
	   MULTIPLY_DECLARED_VARIABLE, WRONG_FUNCTION, NON_PROCEDURE, MOD_ERROR, INTEGER_EXPECTED, 
	   ETYPE_ERROR_A, ETYPE_ERROR_R
   };
